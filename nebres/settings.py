"""
Django settings for nebres project.
...
SECRET_KEY = 'django-insecure-ce#k*r+hxdr@d!xo^^lr2wp%+ehu6vv4dzp60^m8#m42^d-dr0'
...
WSGI_APPLICATION = 'nebres.wsgi.application'
